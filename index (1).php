...
<body class="bg-gray-900 text-white">
  ...
  <nav class="fixed w-full z-50 backdrop-blur bg-black/0">
    <div class="flex h-16 items-center justify-center max-w-7xl mx-auto px-4">
      ...
      <div class="hidden sm:flex space-x-2 items-center">
        ...
        <a href="index.php" class="text-white bg-gray-900 px-3 py-2 rounded-md text-sm font-medium">Accueil</a>
  ...
  <main id="cover" class="min-h-screen flex flex-col items-center justify-center text-center px-4 bg-cover bg-center bg-no-repeat pt-16 relative">
    ...
    <div class="relative z-10 max-w-xl text-white px-4 sm:px-6 lg:px-8">
      <h1 class="text-3xl sm:text-5xl font-extrabold mb-4">Bienvenue sur Uma Revolution !</h1>
      <p class="text-sm sm:text-lg mb-8 whitespace-pre-line">
        Ce site est privé et est associé au serveur Discord 馬レボリューション.
        Si tu souhaites faire partie de l'aventure, il suffit de contacter Tailsuika sur Discord !
      </p>
      <a href="connexion.php" class="bg-indigo-600 hover:bg-indigo-700 font-semibold py-3 px-8 rounded-lg transition duration-300">
        Déjà membre ?
      </a>
    </div>
  </main>
